    ...
    new Vue({
        ...
        data() {
            return {
                ...
                currentAngle: 0,
                winningSector: '',
                targetSectorIndex: 3, // Default value
            };
        },
        computed: {
            wheel() {
        ...
        created() {
            ...
            if (sector === 'jackpot') {
                this.targetSectorIndex = this.sectors.indexOf('💰');
            } else if (sector === 'poop') {
                this.targetSectorIndex = this.sectors.indexOf('💩');
            } else if (sector) {
        ...
        methods: {
            ...
            async spin() {
                ...
                const urlParams = new URLSearchParams(window.location.search);
                const spinId = urlParams.get('spin_id');
                ...
                if (queryId) {
                    Telegram.WebApp.MainButton.setText('CLAIM').show().onClick(function () {
                        const resultMessage = {
                            ...
                            input_message_content: {
                                message_text: `Congratulations! You won ${pointsText} from the Flagship Wheel of Fortune.`
                            }
                        };

                        Telegram.WebApp.sendData(JSON.stringify({ queryId: queryId, resultMessage: resultMessage }));
                    ...
                    Telegram.WebApp.BackButton.onClick(function () {
                        const resultMessage = {
                            ...
                            title: headerText,
                            input_message_content: {
                                message_text: `You won ${pointsText} from the Flagship Wheel of Fortune, but didn't claim the prize.`
                            }
                        };
                    ...
                    console.warn('Query ID not found in initData');
                }
            },
            isEmoji(value) {
